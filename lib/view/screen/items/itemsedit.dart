            ...
            children: [
              ...
              CustomTextFormAuth(
                ...
                const  SizedBox(height: 10,),
                  RadioListTile(title:const Text("hidden"),value: "0", groupValue: controller.active, onChanged: (val){
                    controller.changeactive(val);
                  }),
                const  SizedBox(height: 10,),
                  RadioListTile(title:const Text("Active"),value: "0", groupValue: controller.active, onChanged: (val){
                    controller.changeactive(val);
                  }),
